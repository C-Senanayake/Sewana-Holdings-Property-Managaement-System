...
$user_id='';
    ...
    if(isset($_GET['user_id'])){
        ...
        $query="SELECT * FROM np_daily WHERE NP_Name='{$np_name}' LIMIT 1";
    ...
    if(isset($_POST['submit'])){
        ...
        $email= $_POST['Email'];     
         ...
         $req_fields=array('user_id', 'Email');
        ...
        if(empty($errors)){
            ...
            $Query= "UPDATE np_daily SET NP_Email='{$Email}'";
...
<body>
    ...
    <div class="loggedin">Welcome <span class="name"><?php echo $_SESSION['First_Name']; ?>!</span></span>&emsp; <a href="../logout.php" class="logout">Log out</a> </div>
    </nav>
    ...
    <form action="edit.php" method="POST">
        <input type="hidden" name="user_id" value="<?php echo $np_name;?>">
         ...
         <div class="inputs"><input type="text" name="Name" id="input" placeholder="Full Name" <?php echo 'value="'. $name. '"';?> disabled></div></div>
