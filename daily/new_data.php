...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $contact_No= $_POST['Contact_No'];
         ...
         $req_fields=array('Name', 'Contact_No');
        ...
        $max_len_fields=array('Name'=> 100 ,  'Contact_No'=> 40 );
        ...
        if(empty($errors)){
            ...
            $query= "INSERT INTO nws_paper(NP_Name,NP_Contact_No)";
            $query.="VALUES ('{$Name}','{$Contact_No}')";
