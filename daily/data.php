...
<?php
    ...
    if(isset($_GET['search'])){
        ...
        $query="SELECT * FROM np_daily WHERE (NP_Name LIKE '%$search%' OR NP_Email LIKE '%$search%' ) ORDER BY NP_Name";
    }else{
       
        $query="SELECT * FROM np_daily ORDER BY NP_Name";
    }
...
<body>
    ...
    <h2 >Daily News Papers&ensp;&ensp;<span>
    <?php
    ...
    <div class="search">
        <form action="data.php" method="GET">
            <input type="text" name="search" placeholder="Type Name/Email & Press Enter" <?php echo $search; ?>autofocus>
        </form>
    </div>
