       ...
       foreach($max_len_fields as $field=>$max_len){
        ...
        if(empty($errors)){
            ...
            if($flag=='0'){  
                ...
                $query= "INSERT INTO supervisor(Emp_ID,S_Appointed_Date)";
...
<body>
    ...
    <h2 >Add New Supervisor&ensp;&ensp;<span >
    <?php
    ...
    <form action="new_data.php" method="POST">
        ...
        <div class="inputs"><input type="text" name="Emp_id" id="input" placeholder="Employee ID" <?php echo 'value="'. $emp_id. '"';?>></div></div>
         ...
         <div class="one_line"><div class="labels"><label for="C_name" name="Appointed_date">Supervisor appointed date:</label></div>
