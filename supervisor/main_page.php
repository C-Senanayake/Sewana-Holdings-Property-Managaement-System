  ...
  <body>
    ...
    <div class="container_1">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="../client/new_data.php">&gtAdd</a>
          <a href="../client/data.php">&gtView/Update/Delete</a>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="../manager/data.php">&gtView-Manager</a>
          <!-- <a href="../supervisor/new_data.php">&gtAdd-Supervisor</a> -->
          <a href="../supervisor/data.php">&gtView-Supervisor</a>
      ...
      <div class="dropdown">
        ...
        <a href="../advertise/new_data.php">&gtAdd Advertisement</a>
          <a href="../advertise/data.php">&gtView/Delete Advertisement</a>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="../property/data.php">&gtView/Update/Delete</a>
        </div>
      </div><br>
      <div class="dropdown">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="../property_requirements/new_data.php">&gtAdd</a>
          <a href="../property_requirements/data.php">&gtView/Update/Delete</a>
        </div>
      </div><br>
    <div class="dropdown">
      <button class="dropbtn">Property Viewing</button> 
      <div class="dropdown-content">
        <!-- <a href="../viewing/new_data.php">&gtAdd</a> -->
        <a href="../viewing/data.php">&gtView/Delete</a>
      </div>
    </div><br>
</div>
